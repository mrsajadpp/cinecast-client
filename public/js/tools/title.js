document.getElementById("generate-button").addEventListener("click", async () => {
    ...
    if (!content) {
        resultArea.textContent = "Please provide some text to generate title.";
        return;
    }
    ...
    try {
        ...
        const response = await fetch("https://tools-api-alpha.vercel.app/api/title/generate", {
            method: "POST",
            headers: {
        ...
        console.error("Error calling the title generator API:", error);
